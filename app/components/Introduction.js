...
const Introduction = () => {
  return (
    <div className='min-h-svh sm:max-md:gap-24 sm:items-center sm:justify-center  sm:max-xl:flex  sm:max-xl:flex-col w-full lg:gap-36 lg:flex xl:flex-row'>
      ...
      <img src='images/profile.jpg' className='sm:max-md:w-1/2 rounded-xl grayscale lg:z-10 lg:h-3/4 xl:h-3/4' alt='Profile' />
      <div className=' py-4 px-2 lg:py-0 lg:px-0'>
  
        <table className='text-left sm:text-sm md:text-2xl'>
          <tbody>
            <tr className='py-4'>
